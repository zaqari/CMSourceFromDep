...
df_in = pd.read_csv('/Users/ZaqRosen/Documents/Corpora/mohler/all_data10.csv', names=cols, skipinitialspace=True)
...
df_train_idx=[]
df_test_idx=[]
create_train_test(df_in, df_train_idx, df_test_idx)
...
train_a=[]
test_a=[]
omit_notref(df_tr2, train_a)
omit_notref(df_te2, test_a)

df_tr3=pd.DataFrame(np.array(train_a).reshape(-1, 8), columns=cols)
df_te3=pd.DataFrame(np.array(test_a).reshape(-1, 8), columns=cols)
...
train_c=[]
test_c=[]
enumerate_labels(df_tr3, df_te3, train_c, test_c)
...
df_train.to_csv('/Users/ZaqRosen/Documents/Corpora/mohler/train_data10v3.csv', sep=',', header=False, index=False, encoding='utf-8')
df_test.to_csv('/Users/ZaqRosen/Documents/Corpora/mohler/test_data10v3.csv', sep=',', header=False, index=False, encoding='utf-8')
