...
Train_Data2 = '/Users/ZaqRosen/Documents/Corpora/mohler/train_data6.csv'
Test_Data2 = '/Users/ZaqRosen/Documents/Corpora/mohler/test_data6.csv'

feature_columns = ['LmTarget', 'subj', 'dobj', 'syn', 'obl1', 'obl2', 'verb']
DNN_COLUMNS = ['LmTarget', 'subj', 'dobj', 'syn', 'obl1', 'obl2', 'verb', 'Labels']
...
CATEGORICAL_COLUMNS = ['LmTarget', 'subj', 'dobj', 'syn', 'obl1', 'obl2', 'verb']
...
deep_columns = [
        ...
        # [100, 50] HUnits.
        tf.feature_column.indicator_column(dobj),
        tf.feature_column.indicator_column(subj),
        tf.feature_column.indicator_column(verb),
        tf.feature_column.indicator_column(obl1),
        tf.feature_column.indicator_column(obl2),
        tf.feature_column.indicator_column(tref),
        ]
